...
/**   
 * 邮件发送器   
 * @author FH QQ 13161618211[silence]
 */    
  ...
  */    
    ...
    public static void main(String[] args) throws Exception{   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("13161618211@163.com");    
	     mailInfo.setPassword("719581][p");//您的邮箱密码    
	     mailInfo.setFromAddress("13161618211@163.com");    
	     mailInfo.setToAddress("1924836059@qq.com");    
