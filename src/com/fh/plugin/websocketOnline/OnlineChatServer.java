...
public class OnlineChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		}else if(null != message && message.startsWith("[QQ13161618211]")){
			OnlineChatServerPool.setsilenceadmin(conn);
			this.getUserList();
		}else{
	...
	public void getUserList(){
		WebSocket conn =  OnlineChatServerPool.getsilenceadmin();
		if(null == conn){return;}
		JSONObject result = new JSONObject();
	 ...
	 * @param conn
	 */
	public void addUserTosilenceadmin(String user){
		WebSocket conn =  OnlineChatServerPool.getsilenceadmin();
		if(null == conn){return;}
		JSONObject result = new JSONObject();
