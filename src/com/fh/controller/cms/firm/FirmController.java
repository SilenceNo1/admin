package com.fh.controller.cms.firm;
...
import com.fh.service.cms.firm.FirmManager;
...
/**
 * 说明：经纪公司 创建人：Silence13161618211 创建时间：2016-11-29
 */
@Controller
...
public class FirmController extends BaseController {
	...
	public ModelAndView save() throws Exception {
		...
		pd.put("UPDATED", Tools.date2Str(new Date())); // 更新时间
		firmService.save(pd);
	...
	public ModelAndView list(Page page) throws Exception {
		...
		mv.setViewName("cms/firm/firm_list");
	...
	public ModelAndView goAdd() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("cms/firm/firm_edit");
	...
	public ModelAndView exportExcel() throws Exception {
		...
		for (int i = 0; i < varOList.size(); i++) {
			...
			vpd.put("var4", varOList.get(i).getString("CREATED")); // 4
			vpd.put("var5", varOList.get(i).getString("UPDATED")); // 5
			varList.add(vpd);
		}
