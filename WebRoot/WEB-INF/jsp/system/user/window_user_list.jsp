				...
				<div class="page-content">
					<div class="row">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									<th class="center" style="width:35px;" id="silenceadminth">
									</th>
									...
									<c:forEach items="${userList}" var="user" varStatus="vs">
										<tr>
											<td class='center' style="width: 30px;">
												<label><input type='radio' name="silenceadmin" value="${user.USERNAME }" onclick="setUser(this.value)" class="ace"/><span class="lbl"></span></label>
											</td>
